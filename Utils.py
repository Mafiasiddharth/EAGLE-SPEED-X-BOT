...
EAGLE = [
    "MADARCHOD TERI MAA KI CHUT ME GHUTKA KHAAKE THOOK DUNGA 🤣🤣    #SBKA_BAAP_SID_OP   ",
    "TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA     #SBKA_BAAP_SID_OP ",
    "TERI VAHEEN NHI HAI KYA? 9 MAHINE RUK SAGI VAHEEN DETA HU 🤣🤣🤩       #SBKA_BAAP_SID_OP ",
    "TERI MAA K BHOSDE ME AEROPLANEPARK KARKE UDAAN BHAR DUGA ✈️🛫      #SBKA_BAAP_SID_OP   ",
    "TERI MAA KI CHUT ME SUTLI BOMB FOD DUNGA TERI MAA KI JHAATE JAL KE KHAAK HO JAYEGI💣    #SBKA_BAAP_SID_OP   ",
    "TERI MAAKI CHUT ME SCOOTER DAAL DUGA👅      #SBKA_BAAP_SID_OP  ",
    "TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA      #SBKA_BAAP_SID_OP ",
    "TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA     #SBKA_BAAP_SID_OP   ",
    "TERI MAA KI CHUT KAKTE 🤱 GALI KE KUTTO 🦮 ME BAAT DUNGA PHIR 🍞 BREAD KI TARH KHAYENGE WO TERI MAA KI CHUT   #SBKA_BAAP_SID_OP  ",
    "DUDH HILAAUNGA TERI VAHEEN KE UPR NICHE 🆙🆒😙   #SBKA_BAAP_SID_OP   ",
    "TERI MAA KI CHUT ME ✋ HATTH DALKE 👶 BACCHE NIKAL DUNGA 😍       #SBKA_BAAP_SID_OP ",
    "TERI BEHN KI CHUT ME KELE KE CHILKE 🍌🍌😍  #SBKA_BAAP_SID_OP    ",
    "TERI BHEN KI CHUT ME USERBOT LAGAAUNGA SASTE SPAM KE CHODE   #SBKA_BAAP_SID_OP  ",
    "TERI VAHEEN DHANDHE VAALI 😋😛     #SBKA_BAAP_SID_OP ",
    "TERI MAA KE BHOSDE ME AC LAGA DUNGA SAARI GARMI NIKAL JAAYEGI     #SBKA_BAAP_SID_OP ",
    "TERI VAHEEN KO HORLICKS PEELAUNGA MADARCHOD😚      #SBKA_BAAP_SID_OP",
    "TERI MAA KI GAAND ME SARIYA DAAL DUNGA MADARCHOD USI SARIYE PR TANG KE BACHE PAIDA HONGE 😱😱    #SBKA_BAAP_SID_OP   ",
    "TERI MAA KO KOLKATA VAALE JITU BHAIYA KA LUND MUBARAK 🤩🤩       #SBKA_BAAP_SID_OP ",
    "TERI MUMMY KI FANTASY HU LAWDE, TU APNI BHEN KO SMBHAAL 😈😈  #SBKA_BAAP_SID_OP ",
    "TERA PEHLA BAAP HU MADARCHOD     #SBKA_BAAP_SID_OP",
    "TERI VAHEEN KE BHOSDE ME XVIDEOS.COM CHALA KE MUTH MAARUNGA 🤡😹      #SBKA_BAAP_SID_OP ",
    "TERI MAA KA GROUP VAALON SAATH MILKE GANG BANG KRUNGA🙌🏻☠️      #SBKA_BAAP_SID_OP ",
    "TERI ITEM KI GAAND ME LUND DAALKE,TERE JAISA EK OR NIKAAL DUNGA MADARCHOD🤘🏻🙌🏻☠️     #SBKA_BAAP_SID_OP  ",
    "AUKAAT ME REH VRNA GAAND ME DANDA DAAL KE MUH SE NIKAAL DUNGA SHARIR BHI DANDE JESA DIKHEGA 🙄🤭🤭   #SBKA_BAAP_SID_OP ",
    "TERI MUMMY KE SAATH LUDO KHELTE KHELTE USKE MUH ME APNA LODA DE DUNGA☝🏻☝🏻😬       #SBKA_BAAP_SID_OP ",
    "TERI VAHEEN KO APNE LUND PR ITNA JHULAAUNGA KI JHULTE JHULTE HI BACHA PAIDA KR DEGI👀👯   #SBKA_BAAP_SID_OP ",
    "TERI MAA KI CHUT MEI BATTERY LAGA KE POWERBANK BANA DUNGA 🔋 🔥🤩       #SBKA_BAAP_SID_OP",
    "TERI MAA KI CHUT MEI C++ STRING ENCRYPTION LAGA DUNGA BAHTI HUYI CHUT RUK JAYEGIIII😈🔥😍      #SBKA_BAAP_SID_OP",
    "TERI MAA KE GAAND MEI JHAADU DAL KE MOR 🦚 BANA DUNGAA 🤩🥵😱       #SBKA_BAAP_SID_OP",
    "TERI CHUT KI CHUT MEI SHOULDERING KAR DUNGAA HILATE HUYE BHI DARD HOGAAA😱🤮👺      #SBKA_BAAP_SID_OP",
    "TERI MAA KO REDI PE BAITHAL KE USSE USKI CHUT BILWAUNGAA 💰 😵🤩    #SBKA_BAAP_SID_OP",
]
