...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@eag.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@gle.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@wal.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@aaa.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
@boy.on(events.NewMessage(incoming=True, pattern=r"\.eagle"))
async def spam(e):
